...
import { DecimalCommaFormatterDirective } from 'src/app/shared/directives/decimal-number-directive';
import { CommaFormatterDirective } from 'src/app/shared/directives/comma-formatter-directive';

@NgModule({
  declarations: [ListingDetailsDialogComponent, MaxDigitsDirective, DecimalCommaFormatterDirective, CommaFormatterDirective],
